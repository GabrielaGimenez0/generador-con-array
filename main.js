...
let libretaPrimTrim = {
    nombre : nombreAlum,
    dni : dniAlumn,
    materia_1_1 : nota1_mat1,
    materia_2_1 : nota1_mat2,
    materia_3_1 : nota1_mat3,
    materia_4_1 : nota1_mat4,
    materia_5_1 : nota1_mat5,

}

libretas.push(libretaPrimTrim);
...
let libretaSegTrim = {
    ...
    materia_4_1 : nota1_mat4,
    materia_5_1 : nota1_mat5,
    materia_1_2 : nota2_mat1,
    materia_2_2 : nota2_mat2,
    materia_3_2 : nota2_mat3,
    materia_4_2 : nota2_mat4,
    materia_5_2 : nota2_mat5

}

libretas.push(libretaSegTrim);
...
let libretaTerTrim = {
    ...
    materia_4_2 : nota2_mat4,
    materia_5_2 : nota2_mat5,
    materia_1_3 : nota3_mat1,
    materia_2_3 : nota3_mat2,
    materia_3_3 : nota3_mat3,
    materia_4_3 : nota3_mat4,
    materia_5_3 : nota3_mat5

}

libretas.push(libretaTerTrim);
...
console.log("Esta es la lista de alumnos ingresados")
